...
timeout -k 2s 10s ../mrmaster ../pg*txt &

# give the master time to create the sockets.
sleep 1

# start multiple workers.
timeout -k 2s 10s ../mrworker ../../mrapps/wc.so &
timeout -k 2s 10s ../mrworker ../../mrapps/wc.so &
timeout -k 2s 10s ../mrworker ../../mrapps/wc.so &
...
# start multiple workers
timeout -k 2s 10s ../mrworker ../../mrapps/indexer.so &
timeout -k 2s 10s ../mrworker ../../mrapps/indexer.so
...
timeout -k 2s 10s ../mrworker ../../mrapps/mtiming.so &
timeout -k 2s 10s ../mrworker ../../mrapps/mtiming.so
...
timeout -k 2s 10s ../mrworker ../../mrapps/rtiming.so &
timeout -k 2s 10s ../mrworker ../../mrapps/rtiming.so
...
rm -f mr-done
(timeout -k 2s 20s ../mrmaster ../pg*txt ; touch mr-done ) &
sleep 1

# start multiple workers
timeout -k 2s 20s ../mrworker ../../mrapps/crash.so &
